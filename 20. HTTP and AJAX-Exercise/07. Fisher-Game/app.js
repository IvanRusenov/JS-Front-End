...
function solution(){
    ...
    const navigationButtons = this.document.querySelectorAll("a");
    navigationButtons.forEach(a => a.classList.remove("active"));

    function loadLogin() {
        logInBtn.href = "src/login.html";
        this.classList.add("active");
    }

    function loadRegister() {
        registerBtn.href = "src/register.html";
        this.classList.add("active");
    }
